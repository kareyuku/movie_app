...
const rateAnime = async ({ animeId, rate, content }) => {
  try {
    const req = await api.post(`/reviews/${animeId}`, { rate, content });
    return req;
  } catch {
    return { err: "Nie udało się ocenić anime." };
  }
};
...
export { getAnime, createAnime, findAnime, rateAnime };
